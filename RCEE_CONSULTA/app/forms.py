...
class PostForm(FlaskForm):
    ...
    summary = TextAreaField("Resumo", validators=[Optional(), Length(max=600)])
    ...
    featured_image = FileField('Imagem de Destaque', validators=[FileAllowed(['jpg', 'jpeg', 'png', 'gif'], 'Apenas imagens são permitidas!')])
